...
<div id="phase1" class="phase-content active card">
  ...
  <div style="background: rgba(0,0,0,0.2); padding: 15px; border-radius: 10px; margin-bottom: 20px;">
    <p>[شرح موسع وتفصيلي جداً (لا يقل عن 500 كلمة) يشرح المفهوم من الصفر ويفصل جميع جوانبه بطريقة شيقة ومبسطة للطلاب مع استخدام القوائم والألوان]</p>
  </div>
  <!-- إلزامي: يجب أن تقوم بتصميم وإنشاء رسومات توضيحية ونماذج بصرية معبرة باستخدام (SVG متقدم وملون) يشرح فكرة الدرس بشكل عملي. -->
  <div style="text-align:center; margin:30px 0; padding:20px; background:rgba(0,0,0,0.3); border-radius:15px; border:1px dashed var(--accent);">
      [كود الـ SVG النماذج التوضيحية والرسوم البيانية هنا]
  </div>
  <div class="math-box">[أضف أهم القواعد أو المعادلات المستخدمة بطريقة جذابة ومفصلة هنا]</div>
</div>

<div id="phase2" class="phase-content card">
  <h2>أمثلة محلولة ونماذج تطبيقية</h2>
  <!-- إلزامي: يجب توفير من 4 إلى 6 أمثلة محلولة بشكل شديد التفصيل. اشرح كل مثال مبدأياً، ثم خطوات الحل خطوة بخطوة بطريقة منطقية. -->
  ...
  <!-- كرر الأمثلة لتصل إلى 5 أمثلة قوية جداً تغطي كافة أفكار الدرس -->
</div>

<div id="phase3" class="phase-content card">
  <h2>تحدي المعرفة السريع (اختبر نفسك)</h2>
  <p style="margin-bottom: 20px; color: var(--muted);">أجب عن الأسئلة التالية للتأكد من استيعابك الكامل للدرس. (5 أسئلة)</p>
  <!-- إلزامي: أضف 5 أسئلة تفاعلية حقيقية تعمل بـ JS (غيّر الـ id لكل سؤال: q1, q2, q3, q4, q5) -->
...
يجب أن تولد الكود أعلاه مستعيضاً عن الأقواس المربعة [...] بمحتوى حقيقي ومفصل ومتعمق متعلق بـ: "${keywords}".
توجيهات صارمة جداً:
1. الشرح يجب أن يكون ضخماً، تفصيلياً جداً (محتوى طويل يلائم درس حقيقي مدته 30 دقيقة)، وليس مجرد نقاط موجزة!
2. النماذج والرسومات التوضيحية (SVG) إجبارية. يجب أن تبني كود رسومات جميلاً ومرتبطاً بالمفهوم لتسهل فهم الطالب للطبيعة البصرية للدرس.
3. وفر 5 أو 6 أمثلة محلولة تفصيلياً، مع تلوين الخطوات وفصل كل خطوة.
4. اختم الدرس بتمرين اختبر نفسك مكون من 5 أسئلة متدرجة الصعوبة.
تذكر: المُخرج النهائي يجب أن يكون كود HTML فقط ويعمل بالكامل كصفحة ويب غنية.
`;
